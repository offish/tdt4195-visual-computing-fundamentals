...
uniform layout(location = 3) mat3x3 modelMatrix;
uniform layout(location = 4) mat4x4 mvpMatrix;
...
void main()
{
    ...
    normal = normalize(normalVector * modelMatrix);

    gl_Position = mvpMatrix * translationMatrix * vec4(position, 1.0f);
